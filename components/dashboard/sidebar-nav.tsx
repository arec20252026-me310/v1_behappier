    ...
    >
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {!collapsed && <span className="text-lg font-semibold">{item.title}</span>}
            </Link>
          )
        })}
      </nav>
      ...
      <div className="p-2 border-t border-sidebar-border space-y-0.5">
        ...
        >
          ...
          {!collapsed && <span className="text-lg font-semibold text-muted-foreground">Start Demo</span>}
        </Link>
        <Link
        ...
        >
          ...
          {!collapsed && <span className="text-lg font-semibold">Settings</span>}
        </Link>
      </div>
    </aside>
  )
